...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$isSubscribedForPushNotificationAtom = Atom(name: '_AppStore.isSubscribedForPushNotification', context: context);
  ...
  set isSubscribedForPushNotification(bool value) {
    _$isSubscribedForPushNotificationAtom.reportWrite(value, super.isSubscribedForPushNotification, () {
  ...
  late final _$setPushNotificationSubscriptionStatusAsyncAction = AsyncAction('_AppStore.setPushNotificationSubscriptionStatus', context: context);

  @override
  Future<void> setPushNotificationSubscriptionStatus(bool val) {
    return _$setPushNotificationSubscriptionStatusAsyncAction.run(() => super.setPushNotificationSubscriptionStatus(val));
  }
