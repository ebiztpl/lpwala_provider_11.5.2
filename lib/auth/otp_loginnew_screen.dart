...
class OTPLoginNewScreen extends StatefulWidget {
  final String ? otp;
  final String ? mobileNumber;
  final String ? userType;

  const OTPLoginNewScreen({Key? key, required this.otp, required this.mobileNumber, this.userType}) : super(key: key);

  @override
  State<OTPLoginNewScreen> createState() => _OTPLoginScreenState();
}

class _OTPLoginScreenState extends State<OTPLoginNewScreen> {
  ...
  void _handleLoginUsers() async {
    ...
    Map<String, dynamic> request = {
      ...
      'contact_number': widget.mobileNumber,
      'otp': widget.otp,
    };
