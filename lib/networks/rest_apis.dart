...
Future<UserData> loginUser(Map request) async {
  try {
    LoginResponse res = LoginResponse.fromJson(await (handleResponse(await buildHttpResponse('loginverifybyotp', request: request, method: HttpMethodType.POST))));
...
Future<LoginWithOtpResponse> loginWithOtpUser(Map request) async {
  try {
    LoginWithOtpResponse res = LoginWithOtpResponse.fromJson(await (handleResponse(await buildHttpResponse('loginwithotp', request: request, method: HttpMethodType.POST))));
